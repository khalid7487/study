...
// Note : time complexity: O(2^n+m) and space complexity: o(n+m)

// Note : After optimize memoized:  time complexity: O(m*n) and space complexity: o(n+m)
...
const optimizeGridTraveler = (m, n, memo = {}) => {
  ...
  if (n === 0 || m === 0) return 0;
  memo[key] =
    optimizeGridTraveler(m - 1, n, memo) + optimizeGridTraveler(m, n - 1, memo);
  return memo[key];
};
